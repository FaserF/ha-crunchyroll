# AI Agent Reference for ha-crunchyroll
...
| Area | Path |
|---|---|
| Integration Entry | `custom_components/crunchyroll/__init__.py` |
| Coordinator | `custom_components/crunchyroll/coordinator.py` |
| Options Flow | `custom_components/crunchyroll/config_flow.py` |
| Tests | `tests/` |
